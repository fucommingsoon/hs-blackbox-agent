...
2. `PB_INTEGRATION.md`: PB 200+ / 外部 800 融合目标和同容器执行方案。
3. `PB_TASK_INVENTORY.md`: 当前本地 ProgramBench 201 个 task 清单。
...
`PB_TASK_INVENTORY.md`；具体执行 runbook 见 `PB_INTEGRATION.md`。
